...
module cpu
  ...
  initial begin
    ...
    instructions[0] = 16'b1110_0000_0000_0010; //LOAD (first number of sequence 0)
    instructions[1] = 16'b1110_0001_0000_0011; //LOAD (second number of sequence 1)
    instructions[2] = 16'b1110_0111_0000_1111; //LOAD (loop count data 3)
    instructions[3] = 16'b0000_0010_0000_0001; //ADD (add r0 and r1)
    ...
    instructions[6] = 16'b1100_0011_1100_0000; //JMP to pc2 3 times
    										   //Finish loop
    instructions[7] = 16'b1111_0000_0001_0100; //Write to RAM
    instructions[8] = 16'b1101_0101_1001_0111; //HALT
